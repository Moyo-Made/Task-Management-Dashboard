...
import lightIcon from "@/public/images/icon-light-theme.svg";
import darkIcon from "@/public/images/icon-dark-theme.svg";
			...
			<div className="bg-white dark:bg-[#2b2c37] shadow-md shadow-[#364e7e1a] w-full py-4 rounded-xl">
				...
				<div>
					{boards.map((board, index) => (
						...
						>
							<Image src={boardIcon} alt="board icon" className="h-4 w-auto" />
